...
def Generate_music(request):
    ...
    if request.method == 'POST':
        ...
        if action == 'generate':
            ...
            if response.status_code == 200:
                ...
                return render(request, 'addmusic.html',{'base64_audio': default, 'category_default': category, 'prompt_default': prompt,'category':f"{category} - {prompt}"})
    ...
    return render(request, 'addmusic.html', {'base64_audio': default,'category':"Happy – Pharrell"})
